...
import 'package:app_test/model/api_adapter.dart';
import 'dart:convert';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _fetchQuizs() async {
    ...
    final response =
        await http.get('https://gc-quiz-test.herokuapp.com/quiz/3/');
